...
public class RealizarAvaliacaoContinua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realizar_avaliacao_continua);
        ...
        BTN_TITULO = (TextView) findViewById(R.id.avaliador_continuo_titulo);

        CX_CAIXADEATIVIDADES = (CaixaDeAtividade) findViewById(R.id.avaliador_continuo_caixa);

        BTN_AVALIAR = (Button) findViewById(R.id.avaliador_continuo_avaliar);

        BTN_RECUPERACAO = (Button) findViewById(R.id.avaliador_continuo_recuperacao);

        BTN_NOTA_FINAL = (Button) findViewById(R.id.avaliador_continuo_notafinal);

        LISTA = (ListView) findViewById(R.id.avaliador_continuo_lista);

        BTN_SALVAR = (Button) findViewById(R.id.avaliador_continuo_salvar);
        BTN_ATIVIDADES = (Button) findViewById(R.id.avaliador_continuo_atividades);

        TXT_NAO = (TextView) findViewById(R.id.avaliador_continuo_nao);
        TXT_SIM = (TextView) findViewById(R.id.avaliador_continuo_sim);
        ...
        ActivityStarter.iniciar_com_argumento(getBaseContext(), BTN_ATIVIDADES, ListadorDeAtividadesActivity.class, "Turma", mTurma);
    ...
    public void escolherNota(String eNota) {
        ...
        if (mNota.contentEquals(AVALIAR)) {
            ...
            mAlunos = Escola.getAlunosComNotasVisiveisEOrdenadosDaTurma(mTurma);
