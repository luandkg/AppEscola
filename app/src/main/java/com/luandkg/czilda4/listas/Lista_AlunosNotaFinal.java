...
public class Lista_AlunosNotaFinal extends BaseAdapter {
    ...
    public Lista_AlunosNotaFinal(Context eContext, ArrayList<AlunoContinuo> lista) {
        mContext = eContext;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        double notafinal = eAluno.getNotaComRecuperacao();
