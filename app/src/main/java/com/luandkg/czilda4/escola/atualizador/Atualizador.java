...
public class Atualizador {
    ...
    public static void avaliacao(String mTurma, int quantidade) {
        ...
        DKG on = SigmaCollection.REQUIRED_COLLECTION_OR_BUILD(Local.COLECAO_ESCOLA);
        ...
        SigmaCollection.WRITE_COLLECTION(Local.COLECAO_ESCOLA, on);
    ...
    public static void chamada(String mTurma, int presente, int ausente, int quantidade) {
        ...
        DKG eDKG = SigmaCollection.REQUIRED_COLLECTION_OR_BUILD(Local.COLECAO_ESCOLA);
        ...
        SigmaCollection.WRITE_COLLECTION(Local.COLECAO_ESCOLA, eDKG);
    ...
    public static ArrayList<Atualizacao> getAtualizacoes() {
        ...
        DKG eOn = SigmaCollection.REQUIRED_COLLECTION_OR_BUILD(Local.COLECAO_ESCOLA);
        ...
        DKG eDKG = SigmaCollection.REQUIRED_COLLECTION_OR_BUILD(Local.COLECAO_TURMAS);
