...
public class DKGAtributo {
    ...
    public boolean isValor(String valorComparavel) {
        return getValor().contentEquals(valorComparavel);
    }

    public boolean isInteiro(int valorComparavel) {
        return getInteiro() == valorComparavel;
    }

    public boolean isBool(boolean valorComparavel) {
